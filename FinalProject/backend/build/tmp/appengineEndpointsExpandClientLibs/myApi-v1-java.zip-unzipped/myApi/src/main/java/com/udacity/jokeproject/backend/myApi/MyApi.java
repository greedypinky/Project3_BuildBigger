...
package com.udacity.jokeproject.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://jokeproject-183804.appspot.com/_ah/api/";
  ...
  public class SayHi extends MyApiRequest<com.udacity.jokeproject.backend.myApi.model.GetJokeBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.udacity.jokeproject.backend.myApi.model.GetJokeBean.class);
  ...
  public class SayJoke extends MyApiRequest<com.udacity.jokeproject.backend.myApi.model.GetJokeBean> {
